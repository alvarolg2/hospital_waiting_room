...
$query = "SELECT citas.*, urgencia.name AS urgencia_name, personal.username AS personal_name, pacientes.username AS paciente_name 
          FROM citas
          ...
          WHERE citas.finish_time IS NOT NULL
          ORDER BY citas.finish_time DESC";
        ...
        <?php while($row = $result->fetch_assoc()): ?>
            <div class="grid-item">
                ...
                <div class="grid-item-content action-icons">
                    <a href="delete_citas_soft.php?id=<?php echo $row["citas_id"]; ?>" title="Eliminar" onclick="return confirmDelete()">🗑️</a>
                </div>
            </div>
        <?php endwhile; ?>
    <?php else: ?>
